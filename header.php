...
<head>
  ...
  <link href="<?php echo  bloginfo('template_directory');?>/css/mdb.min.css" rel="stylesheet">
  <!-- Your custom styles (optional) -->
  <link href="<?php echo  bloginfo('template_directory');?>/css/style.min.css" rel="stylesheet">
  <style type="text/css">
    html,
    body,
    header,
